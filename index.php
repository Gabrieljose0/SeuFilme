...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <div class="container-fluid">
      <a class="navbar-brand" href="movies2.php">Navbar</a>
      <form class="d-flex" action="movies2.php" method="post">
        <input class="form-control me-sm-2" type="get" placeholder="Search" id="pesquisa" name="pesquisa">
